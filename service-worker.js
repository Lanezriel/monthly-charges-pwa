const a = /* @__PURE__ */ location.pathname.split("/").slice(0, -1).join("/"), i = [
  a + "/_app/immutable/entry/app.89ef7000.js",
  a + "/_app/immutable/assets/0.12a30921.css",
  a + "/_app/immutable/nodes/0.fa4825f6.js",
  ...
  a + "/_app/immutable/nodes/1.2ec3acfc.js",
  ...
  a + "/_app/immutable/chunks/singletons.3c004ec3.js",
  a + "/_app/immutable/chunks/stores.bcc9b634.js",
  a + "/_app/immutable/entry/start.3806d4b7.js"
], m = [
  a + "/.nojekyll",
  a + "/favicon.png",
  a + "/icon192.png",
  ...
  a + "/robots.txt",
  a + "/touch-icon.png"
], l = "1693486402571", n = self, p = "monthly-charges", c = `${p}_${l}`, r = i.concat(m);
