const a = /* @__PURE__ */ location.pathname.split("/").slice(0, -1).join("/"), r = [
  a + "/_app/immutable/entry/app.55d9298e.js",
  a + "/_app/immutable/assets/0.cd0b29c6.css",
  a + "/_app/immutable/nodes/0.9e2ccbd8.js",
  ...
  a + "/_app/immutable/nodes/1.caed68a3.js",
  ...
  a + "/_app/immutable/chunks/singletons.ff6813d5.js",
  a + "/_app/immutable/chunks/stores.a4251f58.js",
  a + "/_app/immutable/entry/start.d5916c1d.js"
], f = [
  a + "/.nojekyll",
  a + "/favicon.png",
  a + "/icon192.png",
  a + "/icon512.png",
  a + "/robots.txt"
], i = "1692987916534", c = self, l = `cache${i}`, m = r.concat(f), h = new Set(m);
