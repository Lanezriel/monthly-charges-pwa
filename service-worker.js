const a = /* @__PURE__ */ location.pathname.split("/").slice(0, -1).join("/"), r = [
  a + "/_app/immutable/entry/app.1e2ae504.js",
  a + "/_app/immutable/assets/0.fa9427ff.css",
  a + "/_app/immutable/nodes/0.7e15adf1.js",
  ...
  a + "/_app/immutable/nodes/1.9c3e4837.js",
  ...
  a + "/_app/immutable/chunks/singletons.6036b5e2.js",
  a + "/_app/immutable/chunks/stores.f39ac666.js",
  a + "/_app/immutable/entry/start.fcab87c5.js"
], f = [
  a + "/.nojekyll",
  a + "/favicon.png",
  a + "/icon192.png",
  a + "/icon512.png",
  a + "/robots.txt"
], i = "1692967003083", c = self, l = `cache${i}`, m = r.concat(f), h = new Set(m);
