const a = /* @__PURE__ */ location.pathname.split("/").slice(0, -1).join("/"), i = [
  a + "/_app/immutable/entry/app.ec9ed1b8.js",
  a + "/_app/immutable/assets/0.cd0b29c6.css",
  a + "/_app/immutable/nodes/0.bd01f769.js",
  ...
  a + "/_app/immutable/nodes/1.6e4050bb.js",
  ...
  a + "/_app/immutable/chunks/singletons.b186bb95.js",
  a + "/_app/immutable/chunks/stores.5abc0a7c.js",
  a + "/_app/immutable/entry/start.cba2f764.js"
], m = [
  a + "/.nojekyll",
  a + "/favicon.png",
  a + "/icon192.png",
  a + "/icon512.png",
  a + "/robots.txt"
], l = "1693235274184", n = self, p = "monthly-charges", c = `${p}_${l}`, r = i.concat(m);
