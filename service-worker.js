const a = /* @__PURE__ */ location.pathname.split("/").slice(0, -1).join("/"), i = [
  a + "/_app/immutable/entry/app.081417f6.js",
  a + "/_app/immutable/assets/0.b1095948.css",
  a + "/_app/immutable/nodes/0.f78cde93.js",
  ...
  a + "/_app/immutable/nodes/1.750d6623.js",
  ...
  a + "/_app/immutable/chunks/singletons.d1d8098b.js",
  a + "/_app/immutable/chunks/stores.a983efe7.js",
  a + "/_app/immutable/entry/start.7c7b5be9.js"
], m = [
  a + "/.nojekyll",
  a + "/favicon.png",
  a + "/icon192.png",
  ...
  a + "/robots.txt",
  a + "/touch-icon.png"
], l = "1693480851797", n = self, p = "monthly-charges", c = `${p}_${l}`, r = i.concat(m);
