const a = /* @__PURE__ */ location.pathname.split("/").slice(0, -1).join("/"), i = [
  a + "/_app/immutable/entry/app.8fc59420.js",
  a + "/_app/immutable/assets/0.cd0b29c6.css",
  a + "/_app/immutable/nodes/0.2be33385.js",
  ...
  a + "/_app/immutable/nodes/1.43a5e85d.js",
  ...
  a + "/_app/immutable/chunks/singletons.927ec4c7.js",
  a + "/_app/immutable/chunks/stores.cfd1b100.js",
  a + "/_app/immutable/entry/start.e3f2b058.js"
], m = [
  a + "/.nojekyll",
  a + "/favicon.png",
  a + "/icon192.png",
  ...
  a + "/robots.txt",
  a + "/touch-icon.png"
], l = "1693321165286", n = self, p = "monthly-charges", c = `${p}_${l}`, r = i.concat(m);
