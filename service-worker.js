const a = /* @__PURE__ */ location.pathname.split("/").slice(0, -1).join("/"), i = [
  a + "/_app/immutable/entry/app.35eca090.js",
  a + "/_app/immutable/assets/0.cd0b29c6.css",
  a + "/_app/immutable/nodes/0.ff634fbd.js",
  ...
  a + "/_app/immutable/nodes/1.69804bf8.js",
  ...
  a + "/_app/immutable/chunks/singletons.ed94e515.js",
  a + "/_app/immutable/chunks/stores.61d354fd.js",
  a + "/_app/immutable/entry/start.4f38a2ba.js"
], m = [
  a + "/.nojekyll",
  a + "/favicon.png",
  a + "/icon192.png",
  a + "/icon512.png",
  a + "/robots.txt"
], l = "1693235526171", n = self, p = "monthly-charges", o = `${p}_${l}`, f = i.concat(m);
